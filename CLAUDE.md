...
This project is indexed by GitNexus as **claude-code-flow** (1090 symbols, 1530 relationships, 37 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
