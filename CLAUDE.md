...
This project is indexed by GitNexus as **claude-code-flow** (465 symbols, 1029 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
