...
This project is indexed by GitNexus as **claude-code-flow** (659 symbols, 1324 relationships, 23 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
