...
prompt='You are in a repository containing the claude-code-flow Claude Code plugin. Explain what /brainstorm, /write-plan, /execute-plan, /plan, /quick-fix, and /workflow-status are for. Include the expected order for a non-trivial feature.'
...
assert_contains "$output" "/plan" "mentions plan command"
