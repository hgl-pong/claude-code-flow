...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/claude-code-flow
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/ccflow-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using claude-code-flow:subagent-driven-development. The plan is at: $PLAN_PATH"
