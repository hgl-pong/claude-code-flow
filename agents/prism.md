...
1. **Read Plan** — `plan-state.json` for requirements, `<output_dir>/plan-brief.md` for brief (output_dir from envelope; check `.claude/flow/uli/<slug>/` or `.claude/flow/plans/<slug>/`)
