...
## Is this a Claude Code Flow issue or a platform issue?
<!-- Claude Code Flow is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Claude Code Flow installed.

     If the problem persists without Claude Code Flow, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Claude Code Flow installed
