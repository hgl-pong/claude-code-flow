...
5. **Brainstorm** if the task is new, behavior-changing, UI-facing, architectural, or a broad refactor. Save design specs to `.claude/flow/designs/<topic>-design.md`. Note: design specs ≠ DESIGN.md (the design system token document).
